...
CREATE TABLE `tl_module` (
  ...
  `backboneit_mod_article_page` int(10) unsigned NOT NULL default '0',  
  `backboneit_mod_article_setColumns` char(1) NOT NULL default '',
  `backboneit_mod_article_columns` blob NULL,
