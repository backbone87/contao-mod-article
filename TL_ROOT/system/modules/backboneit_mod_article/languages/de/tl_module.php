...
$GLOBALS['TL_LANG']['tl_module']['backboneit_mod_article_id']
	= array('Bezogener Artikel', 'Bitte wählen Sie den Artikel aus, den Sie einfügen möchten.');
	
$GLOBALS['TL_LANG']['tl_module']['backboneit_mod_article_nosearch']
	= array('Nicht durchsuchen', 'Schließt dieses Artikelmodul von der Contao-Suche aus.');
	
$GLOBALS['TL_LANG']['tl_module']['backboneit_mod_article_container']
